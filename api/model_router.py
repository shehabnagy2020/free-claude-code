...
class ModelRouter:
    ...
    def resolve(self, claude_model_name: str) -> ResolvedModel:
        # Try direct gateway or provider-prefixed model first
        (
            direct_provider_id,
        ...
        if direct_provider_id is not None and direct_provider_model is not None:
            thinking_enabled = (
                ...
                else self._settings.resolve_thinking(claude_model_name)
            )
            logger.info(
        ...
        # Fall back to settings-based resolution (Claude tier names -> default model)
    ...
    def _direct_provider_model(
        ...
        # Gateway-prefixed model IDs: "anthropic/nvidia_nim/z-ai/glm4.7"
        # or "claude-3-freecc-no-thinking/nvidia_nim/z-ai/glm4.7"
        ...
        # Direct provider-prefixed model IDs: "nvidia_nim/z-ai/glm4.7"
